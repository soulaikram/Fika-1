...
class User_Controller extends CI_Controller {
    ...
    {
        if(!logged_in()) redirect('Admin/User_Controller/login');

        // Redirect to your logged in landing page here
        redirect('Admin/User_Controller/dash');
    }
    ...
    {
        // Redirect to your logged in landing page here
        if(logged_in()) redirect('Admin/User_Controller/dash');
    ...
    public function dash()
    {
        ...
        if(get_user_info()->groupId->id<=100){ // i tried to limit the the (page)dash to only the users with groupId <100)
            echo 'Hi, '. user('email') .'. You have successfully  logged in. <a href="'. site_url('Admin/User_Controller/logout') .'">Logout</a>';
